...
int main() {
    ...
    //    std::cout << "Test07: ";
    //    std::cout << (testEqual(itA07, A07)    ? "pass" : "fail") << std::endl;
    //}
    ...
    //   D(i,j) = abs(B(i,j))
    {
        ...
        std::cout << "Test08: ";
        std::cout << (testEqual(itA08, A08)    ? "pass" : "fail") << " ";
        std::cout << (testEqual(itC08, C08)    ? "pass" : "fail") << " ";
        std::cout << (testEqual(itD08, D08)    ? "pass" : "fail") << std::endl;
    }
